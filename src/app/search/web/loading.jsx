//🔃🔃[LOADING EFFECT]🔃🔃 this page will be displayed in the interval of time that we set in the 'page.jsx' from the same folder, this Folder 'WEB', check the 'await new Promise ... '
